...
#define SUBVENDOR_AUREON_UNIVERSE     0x3b155311
...
#define SUBVENDOR_MAUDIO_AP192 0x12143236
#define SUBVENDOR_CANTATIS 0x12142417

#define SUBVENDOR_JULIA         0x31305345
#define SUBVENDOR_MAYA44        0x34315441
